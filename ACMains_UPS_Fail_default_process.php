...
if (isset($_SESSION['login_user']) && isset($_SESSION['id'])) {
	...
	$abc =  "SELECT   a.Customer,a.Bank,a.ATMID,a.ATMShortName,a.SiteAddress,a.DVRIP,a.Panel_make,a.zone as zon,a.City,a.State,b.id,b.panelid,b.createtime,b.receivedtime,b.comment,b.zone,b.alarm,b.closedBy,b.closedtime FROM sites a,`ac_mains_default` b WHERE (a.OldPanelID=b.panelid or a.NewPanelID=b.panelid) and b.zone IN ('029','030') and b.alarm='AT' ";
	//echo $abc; 

	$abc2 = "SELECT  a.Customer,a.Bank,a.ATMID,a.ATMShortName,a.SiteAddress,a.DVRIP,a.Panel_make,a.zone as zon,a.City,a.State,b.id,b.panelid,b.createtime,b.receivedtime,b.comment,b.zone,b.alarm,b.closedBy,b.closedtime FROM sites a,`ac_mains_default` b WHERE (a.OldPanelID=b.panelid or a.NewPanelID=b.panelid) and b.zone IN ('001','002')and a.panel_make='SMART -I' and b.alarm='BA'";
	$abc3 = "SELECT  a.Customer,a.Bank,a.ATMID,a.ATMShortName,a.SiteAddress,a.DVRIP,a.Panel_make,a.zone as zon,a.City,a.State,b.id,b.panelid,b.createtime,b.receivedtime,b.comment,b.zone,b.alarm,b.closedBy,b.closedtime FROM sites a,`ac_mains_default` b WHERE (a.OldPanelID=b.panelid or a.NewPanelID=b.panelid) and b.zone IN ('551','552')and (a.Panel_Make = 'securico_gx4816' OR a.Panel_Make = 'sec_sbi') and b.alarm ='BA'";
	$abc4 = "SELECT  a.Customer,a.Bank,a.ATMID,a.ATMShortName,a.SiteAddress,a.DVRIP,a.Panel_make,a.zone as zon,a.City,a.State,b.id,b.panelid,b.createtime,b.receivedtime,b.comment,b.zone,b.alarm,b.closedBy,b.closedtime FROM sites a,`ac_mains_default` b WHERE (a.OldPanelID=b.panelid or a.NewPanelID=b.panelid) and b.zone IN ('027','028')and a.Panel_Make = 'SEC' and b.alarm ='BA'";
		...
		while ($row = mysqli_fetch_array($result)) { ?>
			...
			<tr style="background-color:#cfe8c7">
				...
				if ($row["alarm"] == "AT" and $row["zone"] == "029") {
					...
					<?php
					$xyz = "select createtime from ac_mains_default where panelid='" . $row['panelid'] . "' and zone='029' and alarm='AR' and createtime>'" . $row['createtime'] . "' order by createtime limit 1";
				...
				if ($row["alarm"] == "AT" and $row["zone"] == "030") {
					...
					<td><?php echo $time; ?></td>
					<?php
					$xyz1 = "select createtime from ac_mains_default where panelid='" . $row['panelid'] . "' and zone='030' and alarm='AR' and createtime>'" . $row['createtime'] . "' order by createtime limit 1";
		...
		while ($row = mysqli_fetch_array($result2)) { ?>
			...
			<tr style="background-color:#cfe8c7">
				...
				if ($row["alarm"] == "BA" and $row["zone"] == "001") {
					...
					<?php
					$xyz2 = "select createtime from ac_mains_default where panelid='" . $row['panelid'] . "' and zone='001' and alarm='BR' and createtime>'" . $row['createtime'] . "' order by createtime limit 1";
				...
				if ($row["alarm"] == "BA" and $row["zone"] == "002") {
					...
					$xyz1 = "select createtime from ac_mains_default where panelid='" . $row['panelid'] . "' and zone='002' and alarm='BR' and createtime>'" . $row['createtime'] . "' order by createtime limit 1";
					$xyzresult1 = mysqli_query($conn, $xyz1);
		...
		while ($row = mysqli_fetch_array($result3)) { ?>
			...
			<tr style="background-color:#cfe8c7">
				...
				if ($row["alarm"] == "BA" and $row["zone"] == "551") {
					...
					<?php
					$xyz2 = "select createtime from ac_mains_default where panelid='" . $row['panelid'] . "' and zone='551' and alarm='BR' and createtime>'" . $row['createtime'] . "' order by createtime limit 1";
					$xyzresult2 = mysqli_query($conn, $xyz2);
					$xyzfetch2 = mysqli_fetch_array($xyzresult2);
				} else {
					$xyzfetch2[0] = '-';
				...
				if ($row["alarm"] == "BA" and $row["zone"] == "552") {
					...
					$xyz1 = "select createtime from ac_mains_default where panelid='" . $row['panelid'] . "' and zone='552' and alarm='BR' and createtime>'" . $row['createtime'] . "' order by createtime limit 1";
					$xyzresult1 = mysqli_query($conn, $xyz1);
					$xyzfetch3 = mysqli_fetch_array($xyzresult1);
				} else {
					$xyzfetch3[0] = '-'; ?>
		...
		while ($row = mysqli_fetch_array($result4)) { ?>
			...
			<tr style="background-color:#cfe8c7">
				...
				if ($row["alarm"] == "BA" and $row["zone"] == "027") {
					...
					<?php
					$xyz2 = "select createtime from ac_mains_default where panelid='" . $row['panelid'] . "' and zone='027' and alarm='BR' and createtime>'" . $row['createtime'] . "' order by createtime limit 1";
					$xyzresult2 = mysqli_query($conn, $xyz2);
					$xyzfetch2 = mysqli_fetch_array($xyzresult2);
				} else {
					$xyzfetch2[0] = '-';
				...
				if ($row["alarm"] == "BA" and $row["zone"] == "028") {
					...
					$xyz1 = "select createtime from ac_mains_default where panelid='" . $row['panelid'] . "' and zone='028' and alarm='BR' and createtime>'" . $row['createtime'] . "' order by createtime limit 1";
					$xyzresult1 = mysqli_query($conn, $xyz1);
					$xyzfetch3 = mysqli_fetch_array($xyzresult1);
				} else {
					$xyzfetch3[0] = '-'; ?>
