...
<form id="formf" name="formf" method="post" action="css_View_alert_export_new.php" >

            <div>
			<center><h1 style="margin-top:70px; color:#fff;"  ><b> View Monitoring Alert Report</b></h1></center>
...
function expfunc()
{
$('#formf').attr('action', 'css_View_alert_export_new.php').attr('target','_blank');
$('#formf').submit();
