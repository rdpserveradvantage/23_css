...
if (isset($_SESSION['login_user']) && isset($_SESSION['id'])) {
    ...
    <head>
        ...
        <script>
            ...
            function a(strPage, perpg) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'vmalert_process_checking.php',
                    data: 'panelid=' + panelid + '&ATMID=' + ATMID + '&DVRIP=' + DVRIP + '&from=' + from + '&to=' + to + '&Page=' + Page + '&perpg=' + perp + '&compy=' + compy + '&viewalert=' + viewalert + '&panelmak=' + panelmak+ '&offset=' + offset + '&limit=' + limit,
    ...
    <body style="background-color: #dce079">
        ...
        <form id="formf" name="formf" method="post" action="css_View_alert_export.php">
            ...
            <div>
                <center>
                    <h1 style="margin-top:70px; color:#fff;"><b> View Alert</b></h1>
                </center>
                ...
                <table border="1" style="margin-top:40px; width:90%; " align="center">
                    ...
                    <tr style="background-color:#8cb77e">
                        ...
                        <input type="button" onclick="tableToExcel('show', 'W3C Example Table')" value="Export to Excel"
                        ...
                        <button onclick="myFunction()" style="float: right;height:30px" style="margin-top:50px">Print this
                            page</button>
                    </tr>
                </table>
            </div>
            ...
            <div><input type="button" onclick="tableToExcel('show', 'W3C Example Table')" value="Export to Excel"
