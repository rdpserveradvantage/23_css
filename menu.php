        ...
        <div class="collapse navbar-collapse">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" id="hdm1" style="color:#fff;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Dashboards</a>
              <div class="dropdown-menu" aria-labelledby="dropdown04">
              <a class="dropdown-item" href="./dynamic_dashboard.php" >Alert Dashboard</a>
              <a class="dropdown-item" href="./shiftDashboardCountWise.php" >Shift Dashboard</a>
              </div>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04" style="overflow:scroll; height:500px;">
           ...
           <a style="" class="dropdown-item" href="bulk_upload_qrt_data.php">Add Bulk QRT</a>
			   <?php } ?>
