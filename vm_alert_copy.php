...
<html>
	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
        ...
        <script>
            ...
            function a(strPage,perpg){ debugger;
...
$('#loadingmessage').hide();
   ...
   document.getElementById("show").innerHTML=msg;
          ...
          <script>
function tableToExcel(tableId, filename = 'export.xls') {
...
<td>To Date:<input type ="date" id ="todate"></td>
		...
		<input type="button" onclick="tableToExcel('show', 'W3C Example Table')" value="Export to Excel 2" style="float: right;height:30px" >
