...
if (isset($_SESSION['login_user']) && isset($_SESSION['id'])) {
	...
	if ($viewalert == "" || $viewalert == 3) {
		...
		$abc = "SELECT  a.Customer,a.Bank,a.ATMID,a.ATMShortName,a.SiteAddress,a.DVRIP,a.Panel_make,a.zone as zon,a.City,a.State,b.id,b.panelid,b.createtime,b.receivedtime,b.comment,b.zone,b.alarm,b.closedBy,b.closedtime,b.sendip,b.sip2 FROM sites a,`alerts_backup` b WHERE (a.OldPanelID=b.panelid or a.NewPanelID=b.panelid) ";
		$abc_new = "SELECT  a.Customer,a.Bank,a.ATMID,a.ATMShortName,a.SiteAddress,a.DVRIP,a.Panel_make,a.zone as zon,a.City,a.State,b.id,b.panelid,b.createtime,b.receivedtime,b.comment,b.zone,b.alarm,b.closedBy,b.closedtime,b.sendip,b.sip2 FROM sites a,`backalerts_backup` b WHERE (a.OldPanelID=b.panelid or a.NewPanelID=b.panelid) ";
